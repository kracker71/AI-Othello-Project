...
class Human(abc.ABC):
    ...
    def human_player(self,state: np.ndarray, *args: Any, **kwargs: Any) -> Optional[Tuple[int, int]]:
    ...
    async def human_player_wrapper(self,state: np.ndarray, *args: Any, **kwargs: Any) -> [Tuple[int, int]]:
        return self.human_player(state)
